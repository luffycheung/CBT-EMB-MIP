...
[](#下载-NDK-和构建工具 "下载 NDK 和构建工具")下载 NDK 和构建工具 {#下载-NDK-和构建工具}
-----------------------------------------------------------------
...
[](#创建支持-C-C-的新项目 "创建支持 C/C++ 的新项目")创建支持 C/C++ 的新项目 {#创建支持-C-C-的新项目}
---------------------------------------------------------------------------
...
### [](#编译运行示例-APP "编译运行示例 APP")编译运行示例 APP {#编译运行示例-APP}
...
3.  如下图，在 APK Analyzer 窗口中，选择 `lib&ltABI&gt/`，你就可以看见
    `libnative-lib.so` 。

![Figer-3.png-58.5kB](http://static.zybuluo.com/wl9739/ei2c0h7dftdi8tp9nuafvt30/Figer-3.png)

[](#将-C-C-代码添加到现有的项目中 "将 C/C++ 代码添加到现有的项目中")将 C/C++ 代码添加到现有的项目中 {#将-C-C-代码添加到现有的项目中}
---------------------------------------------------------------------------------------------------
...
### [](#创建新的-native-source-文件 "创建新的 native source 文件")创建新的 native source 文件
...
### [](#创建-CMake-构建脚本 "创建 CMake 构建脚本")创建 CMake 构建脚本 {#创建-CMake-构建脚本}
...
### [](#添加-NDK-APIs "添加 NDK APIs")添加 NDK APIs {#添加-NDK-APIs}
...
[](#关联本地库与-Gradle "关联本地库与 Gradle")关联本地库与 Gradle {#关联本地库与-Gradle}
-----------------------------------------------------------------
...
### [](#使用-Android-Studio-图形化界面 "使用 Android Studio 图形化界面")使用 Android Studio 图形化界面 {#使用-Android-Studio-图形化界面}
...
### [](#手动配置-Gradle "手动配置 Gradle")手动配置 Gradle {#手动配置-Gradle}
